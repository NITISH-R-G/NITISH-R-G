...
## 2024-05-24 - Accessible Markdown Layout Tables
**Learning:** Using `<table>` elements for layout in Markdown files can cause screen readers to announce tabular data erroneously.
**Action:** Always add `role="presentation"` to layout tables in `.md` files to ensure they are ignored by screen readers.
